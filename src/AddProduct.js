...
class AddProduct extends Component {
  ...
  handleAddDCFile(selectorFiles: FileList) {

    console.log("handleAddDCFile",selectorFiles);

  }

  handleAddMCFile(selectorFiles: FileList) {

    console.log("handleAddMCFile",selectorFiles);
  ...
  render() {
    ...
    <Form.Group widths={2}>
      ...
      <Form.Field>
        ...
        <input onChange={ (e) => this.handleAddMCFile(e.target.files) } type='file' multiple/>
      </Form.Field>
      <Form.Field>
      ...
      <Form.Checkbox
      inline
      label='I agree to the terms and conditsions'
      required/>
